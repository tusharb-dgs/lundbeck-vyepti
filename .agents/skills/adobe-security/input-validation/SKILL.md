...
description: Input validation guidance — type checking, format validation, and sanitization. Use when processing user input, form data, API requests, or data from external sources.
---
