...
description: Secure error handling, logging, and security-monitoring guidance. Use when implementing error handling, logging, exception management, or security monitoring.
---
