---
name: api-security
description: API security guidance covering versioning, auth, rate limits, headers, and testing. Use when designing, implementing, or reviewing an API (REST/GraphQL endpoints, auth scopes, CORS, security headers).
---
