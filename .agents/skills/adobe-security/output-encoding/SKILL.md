...
description: Context-specific output encoding and escaping guidance (HTML, JS, CSS, URL, SQL, shell, XML, LDAP, JSON) for stopping injection attacks. Use when rendering user data in HTML, JavaScript, SQL, URLs, or other output contexts.
---
