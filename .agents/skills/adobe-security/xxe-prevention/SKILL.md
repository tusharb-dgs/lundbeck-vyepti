---
name: xxe-prevention
description: XXE prevention guidance for XML parsing — disabling DTDs/external entities and limiting resource consumption. Use when code parses or processes XML, regardless of language or framework, including generated code.
---
