...
description: Secure Node.js/JavaScript development rules — avoid eval, unsafe child_process, hardcoded secrets, prototype pollution, and dynamic require. Use when writing or reviewing Node.js, JavaScript, or TypeScript code for security issues.
---
