---
name: dangerous-flow-identification
description: Trace untrusted-input flows through code to find injection, SSRF, path traversal, and access-control bugs. Use when asked to test implemented logic for dangers, insecure flows, or "what could go wrong here" style review.
---
