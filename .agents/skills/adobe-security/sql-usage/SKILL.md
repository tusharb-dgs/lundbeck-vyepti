---
name: sql-usage
description: Secure SQL usage guidance — parameterized queries, dynamic SQL, least privilege, and error handling. Use when implementing code that interacts with SQL databases, regardless of language or framework, including generated code.
---
