...
description: Path traversal prevention guidance for filesystem operations. Use when user input influences file paths or filesystem ops (join/resolve, read/write, upload/extract, list/delete, serve files).
---
