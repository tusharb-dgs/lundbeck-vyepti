...
description: Injection prevention guidance covering SQL, command, XSS, and XML/XPath injection. Use when handling user input, database queries, command execution, or output rendering.
---
